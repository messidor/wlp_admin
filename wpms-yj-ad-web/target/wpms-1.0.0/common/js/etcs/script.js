...
$(document).ready(function() {
    ...
    $(".card-header-right .card-option .open-card-option").on('click', function() {
        ...
        if ($this.hasClass('fa-times')) {
            ...
            //버튼에 텍스트형태도 추가되어 수치를 곱하는게 아닌 직접 width를 계산 하는 방식으로 변경
            //var maxWidth = ($this.parent().parent().children().length * 40);
    ...
    $(".card-header-right .full-card").on('click', function() {
        ...
        // var result_body = $(this).parents('.card').find('div.card-block').children("div").children("div:eq(1)");

        // if($(this).hasClass("fa-window-restore") ==  true){
        //     result_body.height(gridContentHeight());
        //     if(result_body.find("td.remain_tr").length > 0){
        //         result_body.find("td.remain_tr").height(result_body.find("td.remain_tr").height() - 362);
        //     }
        // }
        // else{
        //     result_body.height(gridContentHeightMax());
        //     if(result_body.find("td.remain_tr").length > 0){
        //         result_body.find("td.remain_tr").height(result_body.find("td.remain_tr").height() + 362);
        //     }
        // }
