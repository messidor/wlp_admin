...
<script type="text/javascript">
	...
	function loadTableData() {
		...
		frm.addInput("query_id", "status.webUseStatus.select_loginDate");
	...
	function loadTableData2() {
		...
		frm.addInput("query_id", "status.webUseStatus.select_loginUser");
		frm.addParam("dataType", "json");		   // 그리드 불러오는 타입 (기본 json)
	...
	function loadTableData3() {
		...
		frm.addInput("query_id", "status.webUseStatus.select_loginBrowser");
		frm.addParam("dataType", "json");		   // 그리드 불러오는 타입 (기본 json)
	...
	function downExcelData() {
		...
		frm.addInput("query_id", "status.webUseStatus.select_loginListExcel");
		frm.addInput("type", "webUseStatus");
