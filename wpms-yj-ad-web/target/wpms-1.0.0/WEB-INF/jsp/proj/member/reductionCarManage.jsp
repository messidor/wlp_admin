...
<script type="text/javascript">
	...
	function gridRowClickEvent(event) {
		OpenPopupSingle("/member/reductionCarManagePopup.do?apply_code="
				+ event.data.applyCode + "&member_id=" + event.data.memberId
				+ "&confirm_gubn=" + event.data.confirmGubn, 1600, 920, "_Pop");
	}
	...
	function validation() {
		for (var i = 0; i < _gridHelper.getAllGridData().length; i++) {
			if (_gridHelper.getAllGridData()[i].checkValue == "Y"
					&& _gridHelper.getAllGridData()[i].confirmGubn == "Y") {
