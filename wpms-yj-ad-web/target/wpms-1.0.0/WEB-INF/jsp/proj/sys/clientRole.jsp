...
<script type="text/javascript">
	...
	var columnDefs = [
	    ...
	    */
	    ...
	    setColumn(["roleId", "그룹코드", "left", 100], [codeEditFunc, [], true, "", "20"]),
	    setColumn(["roleName", "그룹명", "left", 200], [true, [], false, "", "20"]),
	    setColumn(["roleGubn", "그룹구분", "center", 100], [true, ["select", ${func:codeToJSON(pageContext, 'ROLE_GUBN')}, "value", "text"], false, "", ""]),
	    setColumn(["govCode", "주차장기관", "center", 200], [true, ["select", ${func:queryToJSON(pageContext, 'select.select_parkingGovInfo')},, "value", "text"], false, "", ""]),
	    ...
	    setColumn(["checkValue", "checkValue", "left", 100], [], true, false, false, "")
	];
	...
	function loadTableData(isMsg) {
	    ...
	    frm.addParam("query_id", "sys.clientRole.select_list");
	...
	function saveData() {
	    ...
	    frm.setAction("<c:url value='/sys/role.do' />");
		frm.request();
	}
