...
<script type="text/javascript">
	...
	function loadTableData(isMsg) {
		...
		frm.addParam("query_id", "sys.clientGroupUser.select_groupList");
	...
	function loadTableData2() {
		...
		frm.addParam("query_id", "sys.clientGroupUser.select_userList");
		frm.addParam("admin", "admin");
		frm.addParam("wadmin", "wadmin");
		frm.addParam("enc_col", "admin, wadmin");
		frm.addParam("dataType", "json"); // 그리드 불러오는 타입 (기본 json)
	...
	function saveData() {
		...
		frm.addParam("query_id", "sys.clientGroupUser.grid_data");
