...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEnterApi").click(function() {
			...
			$.ajax({
				url: apiUrl+"getwalletFreeEnterReduce.do?serviceKey="+encodeURIComponent($("#kServiceKey").val())+"&parkingAreaCode="+encodeURIComponent($("#kparkingAreaCode").val())+"&carNumber="+$("#kcarNumber").val(),
				method: "get",
                dataType: "xml",
               	success : function(data, textStatus, jqXHR) {
	                	if (data.count != 0) {
	                		...
	                		if(json.walletFreeApi !== undefined){
	                			alert("입차 - 감면 API 호출이 정상적으로 처리되었습니다.");
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="search_all_wrapper">
			...
			<div class="search-area col-lg-12">
				<form id="frmMain" name="frmMain" method="post" onsubmit="return false" class="form-material form-inline">
					...
					<form:input id="parkingAreaCode" caption="parkingAreaCode" type="autocomplete" className="danger" code="kparkingAreaCode" queryId="autocomplete.select_parkingArea2" />
