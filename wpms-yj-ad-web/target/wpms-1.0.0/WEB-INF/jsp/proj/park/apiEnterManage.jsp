...
<script type="text/javascript">
	...
	$(function() {
		...
		//일자 
		$("#enterDt").initDateOnly("days");
		$("#enterDt2").initTimeOnly(hours + ':' + Math.floor(minutes / 10) * 10  + ':' + seconds); 
		    
		var card_height = $("#mCSB_1_container_wrapper").outerHeight() - $(".card").parent().outerHeight() - 40;
		...
		$("#btnEnterApi").click(function() {
			...
			$.ajax({
				url: apiUrl+"getwalletFreeEnter.do?serviceKey="+encodeURIComponent($("#kServiceKey").val())+"&parkingAreaCode="+encodeURIComponent($("#kparkingAreaCode").val())+"&carNumber="+$("#kcarNumber").val()+"&enterDt="+$("#enterDt").val()+" "+$("#enterDt2").val().replace(/ /g,""),
				method: "get",
                dataType: "xml",
               	success : function(data, textStatus, jqXHR) {
	                	if (data.count != 0) {
	                		...
	                		if(json.walletFreeApi !== undefined){
	                			alert("입차 API 호출이 정상적으로 처리되었습니다.");
		                		...
		                		$("#walletFreeYN").val(json.walletFreeApi.body.data.list.walletFreeYN);
		                		if($.isEmptyObject(json.walletFreeApi.body.data.list.reduceCode)){
		                			$("#reduceCode").val("");	
		                		}else{
		                			$("#reduceCode").val(json.walletFreeApi.body.data.list.reduceCode);
		                		}
		                		
		                		if($.isEmptyObject(json.walletFreeApi.body.data.list.reduceNm)){
		                			$("#reduceNm").val("");
		                		}else{
		                			$("#reduceNm").val(json.walletFreeApi.body.data.list.reduceNm);
		                		}
		                		
		                		if($.isEmptyObject(json.walletFreeApi.body.data.list.reduceRate)){
		                			$("#reduceRate").val("");
		                		}else{
		                			$("#reduceRate").val(json.walletFreeApi.body.data.list.reduceRate);
		                		}
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="search_all_wrapper">
			...
			<div class="search-area col-lg-12">
				<form id="frmMain" name="frmMain" method="post" onsubmit="return false" class="form-material form-inline">
					<form:input type="hidden" caption="hEnterUrl" id="hEnterUrl" value="http://192.168.0.55:8131/walletfree/walletFree/getwalletFreeEnter.do"/>
					...
					<form:input id="kcarNumber" caption="carNumber" className="danger" />
					 
					<form:input id="enterDt" caption="enterDt" className="danger"/>
					<form:input id="enterDt2" caption="enterDt2" className="danger"/>
				</form> 
			</div>
			<card:close />
		</div> 
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<card:open title="입차 API 결과" />
			<card:content />
			<div id="enterResult">
	            ...
	            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
		            ...
		            <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-3 no-margin no-padding"> 
		                <label class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 control-label text-right">사전등록여부</label> 
		                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 inputGroupContainer label-attached"> 
		                    <div class="input-group"> 
		                        <span class="input-group-addon"><i class="fas fa-eye" data-icon="fas fa-eye"></i></span> 
		                        <input name="walletFreeYN" id="walletFreeYN" class="form-control " type="text" value="" readonly="readonly"> 
		                    </div> 
		                </div> 
		            </div>
		            <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-3 no-margin no-padding"> 
		                <label class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 control-label text-right">감면코드</label> 
		                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 inputGroupContainer label-attached"> 
		                    <div class="input-group"> 
		                        <span class="input-group-addon"><i class="fas fa-eye" data-icon="fas fa-eye"></i></span> 
		                        <input name="reduceCode" id="reduceCode" class="form-control " type="text" value="" readonly="readonly"> 
		                    </div> 
		                </div> 
		            </div>
		            <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-3 no-margin no-padding"> 
		                <label class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 control-label text-right">감면종류</label> 
		                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 inputGroupContainer label-attached"> 
		                    <div class="input-group"> 
		                        <span class="input-group-addon"><i class="fas fa-eye" data-icon="fas fa-eye"></i></span> 
		                        <input name="reduceNm" id="reduceNm" class="form-control " type="text" value="" readonly="readonly"> 
		                    </div> 
		                </div> 
		            </div>
	            </div>
	            <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-3 no-margin no-padding"> 
	                <label class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 control-label text-right">감면비율</label> 
	                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 inputGroupContainer label-attached"> 
	                    <div class="input-group"> 
	                        <span class="input-group-addon"><i class="fas fa-eye" data-icon="fas fa-eye"></i></span> 
	                        <input name="reduceRate" id="reduceRate" class="form-control " type="text" value="" readonly="readonly"> 
	                    </div> 
	                </div> 
	            </div>  
	            <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-3 no-margin no-padding">  
