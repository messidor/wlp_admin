...
<script type="text/javascript">
	...
	function loadTableData() {
		...
		frm.addParam("query_id", "park.apiEnterAutoPayStatus.select_List");
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
			...
			<div class="search-area col-lg-12">
				<form id="frmMain" name="frmMain" method="post" onsubmit="return false" class="form-material form-inline">
					...
					<form:select id="kParkingNo" caption="주차장 인증코드" all="true" allLabel="전체" queryId="park.apiEnterAutoPayStatus.select_parkInfo"/>
