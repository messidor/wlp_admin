...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEnterApi").click(function() {
			...
			$.ajax({
				url: apiUrl+"getwalletFreeEnterNew.do?serviceKey="+encodeURIComponent($("#kServiceKey").val())+"&parkingAreaCode="+encodeURIComponent($("#kparkingAreaCode").val())+"&carNumber="+$("#kcarNumber").val()+"&enterDt="+$("#enterDt").val()+" "+$("#enterDt2").val().replace(/ /g,""),
				method: "get",
                dataType: "xml",
