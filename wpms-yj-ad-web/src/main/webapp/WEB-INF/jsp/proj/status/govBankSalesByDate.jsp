...
<script type="text/javascript">
    ...
    var BottomcolumnDefs = [
		...
		setColumn(["pGovName", "기관명", "center", 190]),
		setColumn(["pGovAccountName", "통장명", "left", 120]),
		setColumn(["d1", "1일", "right", 100]),
		setColumn(["d2", "2일", "right", 100]),
		setColumn(["d3", "3일", "right", 100]),
		setColumn(["d4", "4일", "right", 100]),
	...
	function handleIQ2(data, textStatus, jqXHR) {
		...
		var maxIndex = endDay + 2;
		setTimeout(function() {
			$("[aria-colindex='"+maxIndex+"']").css("padding-right","12px"),
			$("[aria-colindex='"+maxIndex+"']div").css("padding-right","22px");
		}, 1500);
	...
	function downExcelData() {
		...
		frm.addInput("hParkingNo", $("#kParkingNo").val());
		frm.addInput("query_id", "status.govBankSalesByDate.select_govBankSalesExcel");
		frm.addInput("type", "govBankSalesByDate");
	...
	$(function() {
		...
		$("#kYearDate").initDateSingle("year");
     	...
     	// 조회
        $("#kParkingGovCode, #kParkingNo, #kYearDate, #kMonthDate").change(function(){
        	chartInitialize();
            loadTableData2();
        });
...
<div class="page-body" style="font-size: 0.9em;">
	<div class="row">
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<card:open title="일자별 기관 주차장 매출/정산 집계" />
			<card:content />
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding: 0;">
			<card:open title="일자별 기관 주차장 매출/정산 리스트" />
