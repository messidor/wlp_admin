...
<script type="text/javascript">
	...
	function loadTableData() {
	    ...
	    frm.addParam("query_id", "status.parkingTimeStatus.select_parkTimeStatusList");
	...
	function downExcelData() {
		...
		for(var i=0; i<24; i++){
			time = (i+1) < 10 ? "0" + (i+1) : (i+1);
			timeArray.push(time);
			frm.append("<input type='hidden' name='kTimeArr[]' value='" + (time) + "' />");
		}
	    ...
	    frm.addInput("query_id", "status.parkingTimeStatus.select_parkTimeStatusExcel");
		frm.addInput("type", "parkingTimeStatus");
