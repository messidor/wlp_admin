...
<script type="text/javascript">
	...
	function loadTableData() {
		...
		frm.addParam("query_id", "pay.cancelPaymentManage.Select_PopupList");
	...
	function handleIQ(data, textStatus, jqXHR) {
		if(data.length > 0) {
			...
			if(data[0].paymentGubn == "N"){
				$("#parkingName").parent().parent().parent().hide();
			}

			if(data[0].cancelStatus != "A"){
	...
	function saveData() {
		...
		frm.setAction("<c:url value='/payment/updateSuccessData.do' />");
		frm.addParam("dataType", "json");
		frm.request();
	}
	...
	function saveData2() {
		...
		frm.addParam("enc_col", "userId, kMemberId");
		frm.setAction("<c:url value='/payment/updateCancelData.do' />");
		frm.addParam("dataType", "json");
		frm.request();
	}
	...
	$(function(){
		...
		$("#btnApproval").click(function() {
			if(confirm("결제 취소 신청 건을 승인하시겠습니까?")){
				saveData();
			}
		});
		...
		$("#btnReject").click(function() {
			if($("#reqReason").val() == '') {
				alert("결제 취소 신청 건의 거절사유를 입력해주세요.");
				$("#reqReason").focus();
				return false;
			}

			if(confirm("결제 취소 신청 건을 거절하시겠습니까?")){
				saveData2();
			}
		});
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
				...
				<form:input id="kChargeNo" type="hidden" value="${param.chargeNo}" />
		            ...
		            <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 no-margin no-padding" id="cancel_dt">
		                <label class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 control-label text-right" style="width: 150px !important;" id="cancel_dt_text">취소사유</label>
		                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 inputGroupContainer label-attached" style="max-width: calc(100% - 150px);">
		                    <div class="input-group">
	...
	<div class="row padding-left-10 padding-right-10">
		<div class="bottom-btn-area">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right">
				<c:if test="${param.cancelStatus eq 'A' }">
