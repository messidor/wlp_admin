...
<script type="text/javascript">
	...
	function loadTableData(isMsg) {
        ...
        frm.addParam("query_id", "sys.clientUser.select_list");
        frm.addParam("admin", "admin");
        frm.addParam("wadmin", "wadmin");
        frm.addParam("enc_col", "admin, wadmin, kSearchName");
    ...
    function saveData() {
	    ...
	    frm.addParam("sha_col", "grd_userPw[]")

	    frm.setAction("<c:url value='/sys/clientUser.do' />");
		frm.request();
	}
