...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEnterApi").click(function() {
			...
			if($("#totalParkingFee").val() == ""){
				alert("totalParkingFee를 입력해 주세요.");
				return;
			}
			
			if($("#prePayFee").val() == ""){
				alert("prePayFee를 입력해 주세요.");
				return;
			}
			
			if($("#discountFee").val() == ""){
				alert("discountFee를 입력해 주세요.");
				return;
			}
			...
			$.ajax({
				url: apiUrl+"getwalletFreeOutNew.do?serviceKey=" +encodeURIComponent($("#kServiceKey").val()) + "&parkingAreaCode=" + encodeURIComponent($("#kparkingAreaCode").val()) + "&carNumber=" + $("#kcarNumber").val() + "&parkingFee=" + $("#parkingFee").val() + "&reduceCode=" + $("#reduceCode").val() + "&outDt=" + $("#outDt").val()+" "+$("#outDt2").val().replace(/ /g,"") + "&totalParkingFee=" + $("#totalParkingFee").val() + "&prePayFee=" + $("#prePayFee").val() + "&discountFee=" + $("#discountFee").val(),
				method: "GET",
                data: {},
                dataType: "xml",
...
<!-- 					<div class="col-2"></div> -->
					...
					<form:input id="parkingFee" caption="parkingFee" addAttr="maxlength='100'" value="900" className="danger"/>
					<form:input id="totalParkingFee" caption="totalParkingFee" addAttr="maxlength='100'" value="1000" className="danger"/>
					<form:input id="prePayFee" caption="prePayFee" addAttr="maxlength='100'" value="0" className="danger"/>
					<form:input id="discountFee" caption="discountFee" addAttr="maxlength='100'" value="0" className="danger"/>
				</form>
			</div>
			<card:close />
		</div> 
