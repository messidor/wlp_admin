...
<script type="text/javascript">
	 ...
	 */
			...
			setColumn(["pGovName", "기관명", "left", 150]),
			setColumn(["pGovTel", "발신번호", "center", 90]),
            ...
            setColumn(["modId", "수정자", "center", 90]),
		    setColumn(["modDt", "수정일시", "center", 100]),
	];

	setColumnMask(columnDefs, "pGovTel", "phone");
	...
	_gridHelper.addRowDblClickEvent(function(event) {
   		OpenPopupSingle("/park/parkingGovManagePopup.do?pGovCode=" + event.data.pGovCode, 1100, 940, "_Pop5");
	});
	...
	function loadTableData() {
		...
		frm.addParam("query_id", "park.parkingGovManage.select_list");
	...
	$(function() {
		...
		$("#btnRegister").click(function() {
			OpenPopupSingle("/park/parkingGovManagePopup.do",1100, 940, "_Pop");
		});
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
			...
			<div class="search-area col-lg-12">
				<form id="frmMain" name="frmMain" method="post" onsubmit="return false" class="form-material form-inline">
					<form:input id="kSearchName" caption="기관명"/>
