...
<script type="text/javascript">
	 ...
	 */
			...
			setColumn(["totalParkingFee", "주차요금(전체)", "right", 110]),
			setColumn(["totalParkingPrice", "할인요금", "right", 110]),
			setColumn(["prePayFee", "사전결제요금", "right", 110]),
	...
	function loadTableData() {
		...
		frm.addParam("query_id", "park.apiNewOutFailStatus.select_List");
