...
<script type="text/javascript">
	 ...
	 */
			...
			setColumn(["parkingFee", "주차요금", "right", 110]),
			setColumn(["reduceCode", "감면코드", "right", 110])
	];    
	...
	function loadTableData() {
		...
		frm.addParam("query_id", "park.apiOutStatus.select_List");
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
			...
			<div class="search-area col-lg-12">
				<form id="frmMain" name="frmMain" method="post" onsubmit="return false" class="form-material form-inline">
					...
					<form:select id="kParkingNo" caption="주차장 인증코드" all="true" allLabel="전체" queryId="park.apiOutStatus.select_parkInfo"/>
