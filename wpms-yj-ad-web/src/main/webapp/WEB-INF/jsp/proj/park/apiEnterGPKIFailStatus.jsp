...
<script type="text/javascript">
	 ...
	 */
		    ...
		    setColumn(["reduceCode", "감면코드", "center", 80]),
		    setColumn(["reduceNm", "감면종류", "center", 120]),
		    setColumn(["reduceRate", "감면비율", "center", 80])		    
	];         
	...
	function loadTableData() {
		...
		frm.addParam("query_id", "park.apiEnterGPKIFailStatus.select_List");
