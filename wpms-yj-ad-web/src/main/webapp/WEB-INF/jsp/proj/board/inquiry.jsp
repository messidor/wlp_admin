...
<script type="text/javascript">
	...
	var columnDefs = [
		...
		*/ 
		...
		setColumn(["userName", "작성자", "center", 100]),
    ...
    _gridHelper.addRowDblClickEvent(function(event) {			
		OpenPopupSingle("/board/inquiryPopup.do?boardId="+event.data.boardId, 620, 960, "_Pop");
	});
	...
	function loadTableData() {
		...
		frm.addParam("query_id", "board.inquiry.Select_List");
